...
A robust platform for managing bus reservations, integrated with real-time features.
- **Tech Stack:** Java Spring Boot, Next.js, VNPay Integration.
- **Key Features:** High-concurrency seat booking, automated payment flow, and optimized caching.

#### 🎵 Donatefy
A seamless music streaming experience leveraging modern web technologies.
- **Tech Stack:** MERN Stack (MongoDB, Express, React, Node.js), YouTube Data API.
- **Key Features:** Real-time player, personalized playlists, and fluid UI transitions.
